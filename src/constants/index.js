export const myProjects = [
  {
    ...
    href: "",
    logo: "",
    image: "/Portfolio-task/assets/projects/accessories.jpg",
    tags: [
      {
        id: 1,
        name: "C#",
        path: "/Portfolio-task/assets/logos/csharp.svg",
      },
      {
        id: 2,
        name: ".Net",
        path: "/Portfolio-task/assets/logos/dotnet.svg",
      },
      {
        id: 3,
        name: "Ef Core",
      ...
      },  
      {
        id: 4,
        name: "TailwindCSS",
        path: "/Portfolio-task/assets/logos/tailwindcss.svg",
      },
    ],
  },
  {
    ...
    href: "",
    logo: "",
    image: "/Portfolio-task/assets/projects/auth-system.jpg",
    tags: [
      {
        id: 1,
        name: "Auth0",
        path: "/Portfolio-task/assets/logos/auth0.svg",
      },
      {
        id: 2,
        name: "React",
        path: "/Portfolio-task/assets/logos/react.svg",
      },
      {
        id: 3,
        name: "SQLite",
        path: "/Portfolio-task/assets/logos/sqlite.svg",
      },
      {
        id: 4,
        name: "TailwindCSS",
  ...
  },
  {
    ...
    href: "",
    logo: "",
    image: "/Portfolio-task/assets/projects/blazor-app.jpg",
    tags: [
      {
        id: 1,
        name: "Blazor",
        path: "/Portfolio-task/assets/logos/blazor.svg",
      },
      {
        id: 2,
        name: ".NET Core",
        path: "/Portfolio-task/assets/logos/dotnetcore.svg",
      },
      {
        id: 3,
        name: "SQLite",
  ...
  },
  {
    ...
    href: "",
    logo: "",
    image: "/Portfolio-task/assets/projects/game-engine.jpg",
    tags: [
      {
        id: 1,
        name: "C++",
        path: "/Portfolio-task/assets/logos/cplusplus.svg",
      },
      {
        id: 2,
        name: "C#",
      ...
      },
      {
        id: 3,
        name: "Git",
        path: "/Portfolio-task/assets/logos/git.svg",
      },
      {
        id: 4,
        name: "Microsoft",
        path: "/Portfolio-task/assets/logos/microsoft.svg",
      },
    ],
  },
  {
    ...
    tags: [
      {
        id: 1,
        name: "WordPress",
        path: "/Portfolio-task/assets/logos/wordpress.svg",
      },
      {
        id: 2,
        name: "HTML5",
        path: "/Portfolio-task/Portfolio-task//assets/logos/html5.svg",
      },
      {
        id: 3,
        name: "CSS3",
        path: "/Portfolio-task/Portfolio-task//assets/logos/css3.svg",
      },
      {
        id: 4,
        name: "Vite.js",
        path: "/Portfolio-task/Portfolio-task//assets/logos/vitejs.svg",
      },
    ],
  },
  {
    ...
    href: "",
    logo: "",
    image: "/Portfolio-task/assets/projects/elearning.jpg",
    tags: [
      {
        id: 1,
        name: "Blazor",
      ...
      },
      {
        id: 2,
        name: "Azure",
        path: "/Portfolio-task/assets/logos/azure.svg",
      },
      {
        id: 3,
        name: "Stripe",
        path: "/Portfolio-task/assets/logos/stripe.svg",
      },
      {
        id: 4,
        name: "TailwindCSS",
...
export const mySocials = [
  {
    ...
    icon: "/Portfolio-task/assets/socials/whatsApp.svg",
  },
  {
    name: "Linkedin",
    href: "https://www.linkedin.com/in/amy-platt-2213a0358/",
    icon: "/Portfolio-task/assets/socials/linkedIn.svg",
  },
  {
    name: "Instagram",
    href: "https://www.instagram.com/itsamyp/",
    icon: "/Portfolio-task/assets/socials/instagram.svg",
  },
];
